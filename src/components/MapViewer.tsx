...
export function MapViewer({ positions, reservations, onSelect, selectedPositionId }: MapViewerProps) {
  ...
  return (
    <div className="rounded-[2rem] bg-white p-4 shadow-soft ring-1 ring-slate-200">
      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-50" style={{ minHeight: '520px' }}>
        <TransformWrapper
          initialScale={1}
          minScale={0.8}
          maxScale={3}
        ...
        >
          <TransformComponent wrapperStyle={{ width: '100%', height: '100%' }}>
            <div className="relative inline-block w-full" style={{ minHeight: '520px' }}>
